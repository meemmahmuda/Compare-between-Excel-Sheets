...
# Ask user which columns to compare using GUI dialogs
...
# Map user input to actual column names
...
# Get only unmatched data
unmatched = merged[merged['_merge'] != 'both']

# Ask user where to save unmatched file
